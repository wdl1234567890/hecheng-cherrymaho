...
let loadDatas = function(){
	...
	let defaultCollisionMusic='./audio/boom.mp3'
	let score = 2
...
let resetState=function(){
    ...
    for(let key of keys){
    	if(key!='defaultStates' && key!='Engine' && key!='Render'&& key!='World' && key!='Bodies'
    		...
    		&& key!='Composites' && key!='Composite'&& key!='engine' && key!='render'&& key!='mouseConstraint'){
